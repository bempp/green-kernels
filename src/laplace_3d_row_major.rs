...
pub struct Laplace3dKernelRowMajor<T: RlstScalar> {
    _phantom_t: std::marker::PhantomData<T>,
}

impl<T: RlstScalar> Laplace3dKernelRowMajor<T> {
    /// Create new
    pub fn new() -> Self {
        Self {
...
impl<T: RlstScalar + Send + Sync> Kernel for Laplace3dKernelRowMajor<T>
where
